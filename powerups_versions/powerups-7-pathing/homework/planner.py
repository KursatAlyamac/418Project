...
class Planner(torch.nn.Module):
    def __init__(self):
        ...
        self.path_attention = MultiScaleAttention(1024)
        self.path_conv = torch.nn.Sequential(
            torch.nn.Conv2d(1024, 256, kernel_size=3, padding=1),
        ...
        self.powerup_conv1 = torch.nn.Conv2d(1024, 256, kernel_size=3, padding=1)
        ...
        self.racing_line = RacingLinePredictor(1024)

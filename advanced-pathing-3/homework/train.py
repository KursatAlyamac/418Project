...
def train(args):
    ...
    # Use a combination of L1 and MSE loss for better convergence
    ...
    with open('training_losses.txt', 'w') as f:
        for epoch in range(args.num_epoch):
            ...
            for img, label in train_data:
                ...
                # Combined loss
                loss_val = 0.7 * l1_loss(pred, label) + 0.3 * mse_loss(pred, label)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--augment', action='store_true', default=True)  # Enable augmentation

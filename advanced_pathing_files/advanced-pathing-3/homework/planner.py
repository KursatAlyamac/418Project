...
import numpy as np
from train_utils import LRScheduler
...
class Planner(torch.nn.Module):
    ...
    def train_model(self, train_loader, optimizer, epochs=50):
        """Add training method with LR scheduling"""
        scheduler = LRScheduler(optimizer, patience=5, min_lr=1e-6)

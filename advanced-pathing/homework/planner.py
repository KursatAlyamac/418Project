...
class Planner(torch.nn.Module):
    def __init__(self):
        ...
        # Enhanced CNN architecture for better feature extraction
        ...
        # Track feature head for understanding track characteristics
        self.track_features = torch.nn.Sequential(
            torch.nn.AdaptiveAvgPool2d(1),
            torch.nn.Flatten(),
            torch.nn.Linear(64, 32),
            torch.nn.ReLU(),
            torch.nn.Linear(32, 8)  # Track characteristics encoding
        )
